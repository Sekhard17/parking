...
import { Bell, Car, ChevronDown, CreditCard, DollarSign, Download, Home, LogOut, Menu, Moon, PieChart, Settings, Sun, Users, Clock, TrendingUp, Calendar, Hash, ArrowRight, ArrowUpRight, Percent } from 'lucide-react'
...
export default function Dashboard({ initialDarkMode = false, adminName = "Admin" }: DashboardProps) {
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="flex items-center">
                    ...
                    <span className="font-medium text-gray-700 dark:text-gray-200">{adminName}</span>
                  </Button>
                </DropdownMenuTrigger>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="grid gap-6 mb-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="dark:bg-gray-800 border-none shadow-lg rounded-xl overflow-hidden">
                ...
                <CardContent className="pt-4">
                  <div className="text-2xl font-bold text-gray-700 dark:text-white">$ 12.500</div>
                  <p className="text-gray-500 dark:text-gray-400 mt-1">Por vehículo</p>
                </CardContent>
              </Card>
            </div>
